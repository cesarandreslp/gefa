...
const ACTION_COLORS: Record<string, string> = {
  ...
  DOCUMENT_UPLOADED: '#e8eef7', DOCUMENT_DELETED: '#fee2e2', DOCUMENT_VIEWED: '#f3f4f6',
...
const ACTION_TEXT_COLORS: Record<string, string> = {
  ...
  INTERNAL_NOTE: '#003d7a', COMMENT_ADDED: '#003d7a',
  DOCUMENT_UPLOADED: '#003d7a', DOCUMENT_DELETED: '#991b1b', DOCUMENT_VIEWED: '#374151',
