...
export default function GefaLanding() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', color: '#1e293b', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <header style={{ borderBottom: '1px solid #e2e8f0', background: '#fff' }}>
        <div style={{ ...wrap, display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, fontWeight: 700, fontSize: 18 }}>
            <span style={{ background: '#7c3aed', color: '#fff', borderRadius: 9, padding: 7, display: 'flex' }}><ShieldCheck size={20} /></span>
      ...
      {/* Hero */}
      <section style={{ background: 'linear-gradient(180deg, #ede9fe 0%, #f8fafc 100%)', borderBottom: '1px solid #e2e8f0' }}>
        <div style={{ ...wrap, padding: '72px 20px', textAlign: 'center' }}>
          <span style={{ display: 'inline-block', background: '#ddd6fe', color: '#5b21b6', borderRadius: 999, padding: '5px 14px', fontSize: 13, fontWeight: 600, marginBottom: 18 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20 }}>
          {FEATURES.map((f) => (
            <div key={f.title} style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 14, padding: 24 }}>
              <div style={{ background: '#ede9fe', color: '#7c3aed', width: 46, height: 46, borderRadius: 11, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 14 }}>
                <f.icon size={24} />
              </div>
      ...
      <section style={{ background: '#1e1b4b', color: '#e0e7ff' }}>
        <div style={{ ...wrap, padding: '56px 20px', textAlign: 'center' }}>
          ...
          <Link href="/registro-entidad" style={{ ...primaryCta, background: '#fff', color: '#4c1d95' }}>
      ...
      <footer style={{ borderTop: '1px solid #e2e8f0', background: '#fff' }}>
        <div style={{ ...wrap, padding: '24px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          ...
          <Link href="/acceso" style={{ color: '#7c3aed', textDecoration: 'none', fontSize: 14, fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: 6 }}>
...
const primaryCta: React.CSSProperties = { display: 'inline-flex', alignItems: 'center', gap: 8, background: '#7c3aed', color: '#fff', textDecoration: 'none', padding: '12px 22px', borderRadius: 10, fontSize: 15, fontWeight: 700 };
const secondaryCta: React.CSSProperties = { display: 'inline-flex', alignItems: 'center', gap: 8, background: '#fff', color: '#5b21b6', textDecoration: 'none', padding: '12px 22px', borderRadius: 10, fontSize: 15, fontWeight: 700, border: '1px solid #ddd6fe' };
